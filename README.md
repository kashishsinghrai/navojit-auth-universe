...
Explore the specific implementation for your platform:

| Platform | Package Folder | Status | Key Feature |
| :--- | :--- | :--- | :--- |
| **Node.js / TS** | [`/navojit-auth`](./navojit-auth) | ✅ Live | WASM-powered Rust Core |
| **Flutter / Dart** | [`/navojit_auth_flutter`](./navojit_auth_flutter) | ✅ Live | Native performance on Mobile |
| **Rust** | [`/navojit-auth-rs`](./navojit-auth-rs) | 🛠️ Core | The Cryptographic Engine |
| **Python** | [`/navojit-auth-py`](./navojit-auth-py) | 🏗️ Beta | Secure Backend Auth |
